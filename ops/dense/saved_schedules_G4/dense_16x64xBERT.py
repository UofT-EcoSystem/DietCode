...
def dense_1024x768x2304(X, W, T_dense, s):
    ...
    T_dense_local_i_c_o_i, T_dense_local_i_c_i = s[T_dense_local].split(T_dense_local_i_c, factor=4)
    T_dense_local_i_c_o_o_i, T_dense_local_i_c_o_i = s[T_dense_local].split(T_dense_local_i_c_o_i, factor=1)
    T_dense_local_i_c_o_o_o_i, T_dense_local_i_c_o_o_i = s[T_dense_local].split(T_dense_local_i_c_o_o_i, factor=32)
    ...
    T_dense_local_j_c_o_o_o_i, T_dense_local_j_c_o_o_i = s[T_dense_local].split(T_dense_local_j_c_o_o_i, factor=12)
    T_dense_local_j_c_o_o_o_o, T_dense_local_j_c_o_o_o_i = s[T_dense_local].split(T_dense_local_j_c_o_o_o_i, factor=6)
    T_dense_local_k_o_i, T_dense_local_k_i = s[T_dense_local].split(T_dense_local_k, factor=12)
    ...
    T_dense_i_o_i, T_dense_i_i = s[T_dense].split(T_dense_i, factor=4)
    T_dense_i_o_o_i, T_dense_i_o_i = s[T_dense].split(T_dense_i_o_i, factor=32)
    ...
    T_dense_j_o_o_i, T_dense_j_o_i = s[T_dense].split(T_dense_j_o_i, factor=12)
    ...
    W_shared_ax0_ax1_fused_o_o, W_shared_ax0_ax1_fused_o_i = s[W_shared].split(W_shared_ax0_ax1_fused_o, factor=384)
    ...
    X_shared_ax0_ax1_fused_o_o, X_shared_ax0_ax1_fused_o_i = s[X_shared].split(X_shared_ax0_ax1_fused_o, factor=384)
...
def dense_1024x768x3072(X, W, T_dense, s):
    T_dense_i, T_dense_j, T_dense_k = tuple(T_dense.op.axis) + tuple(T_dense.op.reduce_axis)
    T_dense_local, = s.cache_write([T_dense], "local")
    T_dense_local_i_c, T_dense_local_j_c, T_dense_local_k = tuple(T_dense_local.op.axis) + tuple(T_dense_local.op.reduce_axis)
    T_dense_local_i_c_o_i, T_dense_local_i_c_i = s[T_dense_local].split(T_dense_local_i_c, factor=2)
    T_dense_local_i_c_o_o_i, T_dense_local_i_c_o_i = s[T_dense_local].split(T_dense_local_i_c_o_i, factor=16)
    ...
    T_dense_local_j_c_o_o_i, T_dense_local_j_c_o_i = s[T_dense_local].split(T_dense_local_j_c_o_i, factor=1)
    T_dense_local_j_c_o_o_o_i, T_dense_local_j_c_o_o_i = s[T_dense_local].split(T_dense_local_j_c_o_o_i, factor=64)
    ...
    T_dense_local_k_o_o, T_dense_local_k_o_i = s[T_dense_local].split(T_dense_local_k_o_i, factor=12)
    s[T_dense_local].reorder(T_dense_local_i_c_o_o_o_o, T_dense_local_j_c_o_o_o_o, T_dense_local_i_c_o_o_o_i, T_dense_local_j_c_o_o_o_i, T_dense_local_i_c_o_o_i, T_dense_local_j_c_o_o_i, T_dense_local_k_o_o, T_dense_local_k_o_i, T_dense_local_i_c_o_i, T_dense_local_j_c_o_i, T_dense_local_k_i, T_dense_local_i_c_i, T_dense_local_j_c_i)
    T_dense_i_o_i, T_dense_i_i = s[T_dense].split(T_dense_i, factor=32)
    ...
    T_dense_j_o_o_i, T_dense_j_o_i = s[T_dense].split(T_dense_j_o_i, factor=64)
    ...
    s[X_shared].bind(X_shared_ax0_ax1_fused_o_i, te.thread_axis("threadIdx.x"))
    s[T_dense_local].pragma(T_dense_local_i_c_o_o_o_o, "auto_unroll_max_step", 16)
    s[T_dense_local].pragma(T_dense_local_i_c_o_o_o_o, "unroll_explicit", True)


def dense_1024x768x768(X, W, T_dense, s):
    T_dense_i, T_dense_j, T_dense_k = tuple(T_dense.op.axis) + tuple(T_dense.op.reduce_axis)
    T_dense_local, = s.cache_write([T_dense], "local")
    T_dense_local_i_c, T_dense_local_j_c, T_dense_local_k = tuple(T_dense_local.op.axis) + tuple(T_dense_local.op.reduce_axis)
    ...
    T_dense_local_k_o_i, T_dense_local_k_i = s[T_dense_local].split(T_dense_local_k, factor=6)
...
def dense_1024x3072x768(X, W, T_dense, s):
    T_dense_i, T_dense_j, T_dense_k = tuple(T_dense.op.axis) + tuple(T_dense.op.reduce_axis)
    T_dense_local, = s.cache_write([T_dense], "local")
    T_dense_local_i_c, T_dense_local_j_c, T_dense_local_k = tuple(T_dense_local.op.axis) + tuple(T_dense_local.op.reduce_axis)
    T_dense_local_i_c_o_i, T_dense_local_i_c_i = s[T_dense_local].split(T_dense_local_i_c, factor=16)
    T_dense_local_i_c_o_o_i, T_dense_local_i_c_o_i = s[T_dense_local].split(T_dense_local_i_c_o_i, factor=1)
    ...
    T_dense_local_j_c_o_o_i, T_dense_local_j_c_o_i = s[T_dense_local].split(T_dense_local_j_c_o_i, factor=1)
    T_dense_local_j_c_o_o_o_i, T_dense_local_j_c_o_o_i = s[T_dense_local].split(T_dense_local_j_c_o_o_i, factor=128)
    T_dense_local_j_c_o_o_o_o, T_dense_local_j_c_o_o_o_i = s[T_dense_local].split(T_dense_local_j_c_o_o_o_i, factor=1)
    ...
    T_dense_j_o_o_i, T_dense_j_o_i = s[T_dense].split(T_dense_j_o_i, factor=128)
    T_dense_j_o_o_o, T_dense_j_o_o_i = s[T_dense].split(T_dense_j_o_o_i, factor=1)
    s[T_dense].reorder(T_dense_i_o_o_o, T_dense_j_o_o_o, T_dense_i_o_o_i, T_dense_j_o_o_i, T_dense_i_o_i, T_dense_j_o_i, T_dense_i_i, T_dense_j_i)
    s[T_dense_local].compute_at(s[T_dense], T_dense_j_o_i)
    W_shared = s.cache_read(W, "shared", [T_dense_local])
