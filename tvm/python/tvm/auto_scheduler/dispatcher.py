...
class ApplyHistoryBest(DispatchContext):
    ...
    def get_workload_entry(best_records, target_key, workload_key):
        ...
        # <bojian/DietCode>
        # print("workload_key={}, workload_hash={}".format(workload_key, workload_hash))
    ...
    def load(self, records, n_lines=None):
        ...
        if isinstance(records, str):
            ...
            # assert False, "Start of loading the records"

            records = load_records(records)

            # <bojian/DietCode>
            # assert False, "Finished loading the records"
        ...
        print("inp_res_pairs={}, dispatchers={}".format(inp_res_pairs, dispatchers))
        ...
        for disp in dispatchers:
            ...
            # print("workload_hash={}".format(workload_hash))
        ...
        # <bojian/DietCode>
        # assert False, "Finish loading all the records"
    ...
    def _query_inside(self, target, workload_key, func_name):
        ...
        # <bojian/DietCode>
        # print("Schedule for func_name={} has NOT been found".format(func_name))
        ...
        if func_name in DYN_SEARCH_TASK_REGISTRY:
            ...
            # assert ret is not None, "func_name={} not found in log".format(func_name)
            if ret is not None:
                return ret
            for k in target.keys:
        ...
        print("Schedule for func_name={} not found".format(func_name))
