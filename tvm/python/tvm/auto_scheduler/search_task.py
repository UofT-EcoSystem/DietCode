...
class SearchTask(Object):
    ...
    def __init__(
        ...
        #     if not skip_dyn_args_init:
        #         print("Initializing arguments ...")
        #         args, shape_vars = _ffi_api.InitializeDynShapeVars(args, shape_vars,
        #                                                            wkl_insts)
        #         print("Initialized arguments: {}".format(args))
        #     else:
        #         from tvm.tir import DynShapeVar
        #         assert isinstance(shape_vars[0], DynShapeVar)
