...
_runner_kwargs = {'repeat' : 3, 'min_repeat_ms' : 100, 'timeout' : 10}
local_rpc_measure_ctx = auto_scheduler.LocalRPCMeasureContext(**_runner_kwargs)
local_runner = auto_scheduler.LocalRunner(**_runner_kwargs)
